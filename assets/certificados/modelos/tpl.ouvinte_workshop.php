                ...
                <table class="table table-borderless">
                    ...
                    <tr>
                        <td colspan="2" style="font-size:26px;">
                            <p style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A Faculdade de Tecnologia de Garça “Deputado Julio Julinho Marcondes de Moura” confere o presente certificado a {{ nome_aluno }} pela participação como ouvinte no Workshop {{ workshop }},
                                        realizado {{ local_realizacao }}, no dia {{ data_atividade }}, com duração de {{ carga_horaria }} horas.</p>
