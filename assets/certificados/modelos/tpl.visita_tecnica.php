            ...
            <table class="table table-borderless">
                ...
                <tr>
                    <td colspan="2" style="font-size:26px;">
                                    <p style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A Faculdade de Tecnologia de Garça “Deputado Julio Julinho Marcondes de Moura” certifica que {{ nome_aluno }} realizou Visita Técnica à Empresa {{ nome_empresa }},
                                        instalada no município de {{ municipio_empresa }}, com duração total de {{ carga_horaria }} horas</p>
