            ...
            <table class="table table-borderless">
                ...
                <tr>
                    <td colspan="2" style="font-size:26px;">
                                    <p style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A Faculdade de Tecnologia de Garça “Deputado Julio Julinho Marcondes de Moura” confere o presente certificado a {{ nome_aluno }}, pela participação como ouvinte
                                        na palestra "{{ nome_palestra_aluno }}", ministrado por {{ nome_responsavel_palestra_aluno }} {{ local_palestra_aluno}}, no dia {{ data_atividade }}, com duração de {{ carga_horaria }} horas.</p>
