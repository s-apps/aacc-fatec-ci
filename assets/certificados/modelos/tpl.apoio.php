            ...
            <table class="table table-borderless">
                ...
                <tr>
                    <td colspan="2" style="font-size:26px;">
                        <p style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A Faculdade de Tecnologia de Garça “Deputado Julio Julinho Marcondes de Moura” certifica que {{ nome_aluno }} participou da Equipe de Apoio na {{ evento }}, no período de {{ periodo }}, totalizando {{ carga_horaria }} horas.</p>
                        <p style="text-align:right;line-height: 2.8;">Garça, {{ data_atividade }}.</p>
                    </td>
                </tr>
            </table>
            <footer class="footer">
