            ...
            <table class="table table-borderless">
                ...
                <tr>
                    <td colspan="2" style="font-size:26px;">
                        <p style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A Faculdade de Tecnologia de Garça “Deputado Julio Julinho Marcondes de Moura” confere o presente certificado a {{ nome_aluno }}, pela participação no minicurso "{{ nome_minicurso }}", ministrado por {{ nome_responsavel_minicurso }} {{ local_minicurso }}, no dia {{ data_atividade }}, com duração de {{ carga_horaria }} horas.</p>
