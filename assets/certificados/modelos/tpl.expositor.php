            ...
            <table class="table table-borderless">
                ...
                <tr>
                    <td colspan="2" style="font-size:26px;">
                        <p style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Certificamos que, {{ nome_aluno }}, RA. {{ ra }}, participou na qualidade de expositor na {{ nome_exposicao }},
                         da Faculdade de Tecnologia "Deputado Julio Julinho de Marcondes de Moura", realizada no período {{ periodo_exposicao }}, em Garça-SP, com carga horária total de {{ carga_horaria }} horas.</p>
