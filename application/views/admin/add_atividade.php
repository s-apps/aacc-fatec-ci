  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Atividades <small>adicionando</small></h1>
    </section>
    ...
    <section class="content">
      ...
      <!-- Default box -->
      <div class="box">
      <?php $atributos = array('id' => 'frmAddAtividade', 'name' => 'frmAddAtividade'); echo form_open('admin/atividade/inserir', $atributos);?>
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="data_atividade">Data da Atividade</label>
                      <input type="text" class="form-control" id="data_atividade" name="data_atividade" value="<?= set_value('data_atividade',date('d/m/Y'));?>" autofocus="autofocus">
                ...
                <div class="form-group">
                    <label for="carga_horaria">Carga Horária</label>
                      <input type="text" class="form-control timepicker" id="carga_horaria" name="carga_horaria" value="<?= set_value('carga_horaria');?>">
              ...
              <div class="form-group">
                <label for="descricao_atividade">Atividade</label>
                  <textarea class="form-control" rows="5" placeholder="Informe a Atividade" id="descricao_atividade" name="descricao_atividade" style="resize: none;"><?=set_value('descricao_atividade')?></textarea>
              ...
              <div class="form-group">
                  <label for="id_modalidade">Modalidade <span id="duracao_da_modalidade" style="font-weight: normal;color:#666;"></span></label>
                  <select class="form-control" id="id_modalidade" name="id_modalidade">
                    <option></option>
                    <?php foreach($modalidades as $modalidade){?>
                    <option value="<?=$modalidade->id_modalidade;?>"<?=set_select('id_modalidade',$modalidade->id_modalidade);?>><?=$modalidade->nome_modalidade;?></option>
                    <?php }?>
                  </select>
              ...
              <div class="well">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <select class="form-control select2" id="modeloCertificado" name="modeloCertificado" data-formulario="AddAtividade">
                                    <option></option>
